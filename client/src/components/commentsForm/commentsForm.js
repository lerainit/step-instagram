  ...
  return (
    ...
    <Formik
      ...
      onSubmit={async (values, FormikProps) => {
       ...
       await fetch(`${process.env.REACT_APP_API_URL_POSTS}/comments/${props.index}`, {
          method: 'PUT',
          headers: {
       ...
       await dispatch(addCommentsAC({ comment: { userIndex: authIndex, text: values.comment, isVisible: false }, userIndex: props.userIndex, index: props.index, comments: comments }))
